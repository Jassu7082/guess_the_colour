...
function Learn() {
    ...
    return (
        <div className='bg-gray-900 text-white h-lvh '>
            ...
            <div className='App-Body'>
                <div className="colour border border-white p-6">
                    <h1 className='text-[200%] m-4'>Learn</h1>
                    <p className='fill' style={{backgroundColor: colorHex[colorDict[index]]}}>
                    </p>
                </div>
                <div className="colour-name border border-white p-6">
                    <ColorNameStyle name={colorDict[index]} />
                    <div className='btn-divs'>
                        <button className="btn bg-green-500" onClick={decreaseIndex}>Previous</button>
                        <button className="btn bg-green-600" onClick={increaseIndex} >Next</button>
                    </div>
                </div>
            </div>
        </div>
